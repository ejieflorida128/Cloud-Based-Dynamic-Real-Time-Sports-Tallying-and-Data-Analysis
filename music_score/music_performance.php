                              ...
                              $result = mysqli_query($conn,$sqlGetAllDataFromTeam);
                                ...
                                while($testForTeam = mysqli_fetch_assoc($result)){
                                  ...
                                  if($game_type == 'Vocal_Duet'){
                                            ...
                                            <a href = 'criteriaForVocalDuet.php?team_id=$teamId' class='col-md-4 col-sm-6' style = ' box-shadow: 0 0 15px rgba(0, 0, 0, 0.25); border-radius: 20px; margin: 17px; width: 250px; height: 250px;' id = 'EventBox'>
                                    ...
                                    <a href = 'criteriaForPopSolo.php?team_id=$teamId' class='col-md-4 col-sm-6' style = ' box-shadow: 0 0 15px rgba(0, 0, 0, 0.25); border-radius: 20px; margin: 17px; width: 250px; height: 250px;' id = 'EventBox'>
                                                                      <div class = 'pictures' style = 'display: flex; justify-content: center; margin-top: 10px;'>
                                                                      <img src = '$logos' style = 'width: 150px; height: 140px;'>
                                                                      </div>
