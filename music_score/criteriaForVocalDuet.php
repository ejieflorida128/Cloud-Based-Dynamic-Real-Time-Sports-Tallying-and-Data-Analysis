        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              ...
              <a href="music_performance.php?event_id=<?php echo $_SESSION['EventId']; ?>&&game_id=<?php echo $_SESSION['GameId']; ?>&&game_type=<?php echo $_SESSION['GameType']; ?>" class = "btn btn-danger">Back</a>
              ...
              <div class="row" id = 'secondPart'>
                    ...
                    <form action="options.php" method="post">
                        <div class="criteria-container">
                            ...
                            <div class="criteria-item">
                                <label for="voice-quality">Voice Quality (30%)</label>
                            ...
                            <div class="criteria-item">
                                ...
                                <input type="number" id="stage-deportment" name="E" placeholder="Score (0 - 10)" min="0" max="10" value="<?php echo htmlspecialchars($getResult['E']); ?>">
                            </div>
                            <div class="criteria-item">
                            ...
                            <input type="text" name="gameType" hidden value="Vocal_Duet">
                        ...
                        ?>
                          ...
                          <script>
                              function updateTotal() {
                                  ...
                                  const voiceQuality = parseFloat(document.getElementById('voice-quality').value) || 0;
                                const blending = parseFloat(document.getElementById('blending').value) || 0;
                                const interpretation = parseFloat(document.getElementById('interpretation').value) || 0;
                                  const diction = parseFloat(document.getElementById('diction').value) || 0;
                                  const stage_deportment = parseFloat(document.getElementById('stage-deportment').value) || 0;

                                  // Calculate total score
                                  const total = voiceQuality + blending + interpretation + diction + stage_deportment;
                              ...
                              document.getElementById('voice-quality').addEventListener('input', updateTotal);
                              document.getElementById('blending').addEventListener('input', updateTotal);
                              document.getElementById('interpretation').addEventListener('input', updateTotal);
                              document.getElementById('diction').addEventListener('input', updateTotal);
