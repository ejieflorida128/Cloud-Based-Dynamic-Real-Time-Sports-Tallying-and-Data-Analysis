                    ...
                    ?>
                        ...
                        <form action="options.php" method="post">
                            <div class="criteria-container">
                                ...
                                <div class="criteria-item">
                                    <label for="tone-quality">Tone Quality (45%)</label>
                                ...
                                <input type="text" name="gameType" hidden value="Pop_Solo">
                            ...
                            <script>
                                function updateTotal() {
                                    ...
                                    const toneQuality = parseFloat(document.getElementById('tone-quality').value) || 0;
                                    const musicianship = parseFloat(document.getElementById('musicianship').value) || 0;
                                    const stageDeportment = parseFloat(document.getElementById('stage-deportment').value) || 0;

                                    // Calculate total score
                                    const total = toneQuality + musicianship + stageDeportment;
                                ...
                                document.getElementById('tone-quality').addEventListener('input', updateTotal);
                                document.getElementById('musicianship').addEventListener('input', updateTotal);
