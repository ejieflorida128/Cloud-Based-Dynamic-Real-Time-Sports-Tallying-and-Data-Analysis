...
<main>
<div class="title">
    <p style = "font-weight: bolder;">The tally board is hidden for excitement, with results revealed at the victory ball!</p>
</div>
...
<style>
	...
	<div class="message">
    <p class="message__line">The tally board is being prepared for the big reveal...</p>
<p class="message__line">Excitement is building as the final pieces come together...</p>
<p class="message__line">Each detail is carefully placed for the grand announcement...</p>
<p class="message__line">Anticipation is high, as the countdown continues...</p>
<p class="message__line">The winners will soon be revealed in a grand celebration...</p>
<p class="message__line">Victory is near, and the final touches are being made...</p>
<p class="message__line">Get ready for the ultimate victory party, coming soon...</p>
<p class="message__line">All set! Prepare for the grand announcement...</p>


	</div>
    
    
    <div class="DIVbUTTON" style = "display: flex; justify-content: center; margin-top: 20px;">
        <a href = "index.php" style = "border: 1px solid red; padding: 10px; border-radius: 10px; padding-left: 30px; padding-right: 30px; background-color: red; color: white; text-decoration: none;">BACK</a>
    </div>
