  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
        ...
        <span class="ms-1 font-weight-bold">Admin Account Pending</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="loadToSuperAdmin.php">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="loadToAdminUserTable.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Super Admin Account Pending</li>
          </ol>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Time Join</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Action</th>
                    </tr>
                  </thead>
                  <tbody>
                   <?php
                        $sqlForPendingAccounts = "SELECT * FROM accounts WHERE status = 'pending'";
                        $resultForPending = mysqli_query($conn,$sqlForPendingAccounts);


                        while($testForPending = mysqli_fetch_assoc($resultForPending)){
                            $profile = $testForPending['profile'];
                            $fullname = $testForPending['fullname'];
                            $date = $testForPending['date'];
                            $id = $testForPending['id'];
                            ...
                            <td>
                              <div class="d-flex px-2 py-1">
                                ...
                                <div class="d-flex flex-column justify-content-center">
                                  ...
                                  <p class="text-xs text-secondary mb-0">waiting for approval</p>
                                </div>
                              </div>
                            </td>
                            <td>
                              <p class="text-xs font-weight-bold mb-0">Sport</p>
                              <p class="text-xs text-secondary mb-0">Coordinator</p>
                            </td>
                            ...
                            <td class="align-middle">
                                ...
                                <a href = "superAdminApproved.php?id='.$id.'"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <rect width="24" height="24" fill="none" stroke="black" stroke-width="2"/>
                                <path fill="none" stroke="green" stroke-width="2" d="M6 12l4 4 8-8"/>
                              </svg>
                              </a>

                              <a href = "superAdminReject.php?id='.$id.'"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
  <rect width="24" height="24" fill="none" stroke="black" stroke-width="2"/>
  <path fill="none" stroke="red" stroke-width="2" d="M6 6l12 12M18 6l-12 12"/>
</svg>
</a>
                            </td>
                          </tr>
