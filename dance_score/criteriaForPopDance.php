              ...
              <div class="row" id = 'secondPart'>
                    ...
                    <form action="options.php" method="post">
                        <div class="criteria-container">
                            ...
                            <div class="criteria-item">
                                <label for="phrasing-dynamic-musicality">Phrasing, Dynamic, and Musicality (20%)</label>
                                <input type="number" id="phrasing-dynamic-musicality" name="C" placeholder="Score (0 - 20)" min="0" max="20" value="<?php echo htmlspecialchars($getResult['C']); ?>">
                            </div>

                            <div class="criteria-item">
                                <label for="costumes-uniform">Costumes and Uniform (10%)</label>
                                <input type="number" id="costumes-uniform" name="D" placeholder="Score (0 - 10)" min="0" max="10" value="<?php echo htmlspecialchars($getResult['D']); ?>">
                            </div>
                            ...
                            <input type="hidden" name="gameType" value="Pop_Dance">
                        ...
                        <script>
                            function updateTotal() {
                                ...
                                const phrasingDynamicMusicality = parseFloat(document.getElementById('phrasing-dynamic-musicality').value) || 0;
                                const costumesUniform = parseFloat(document.getElementById('costumes-uniform').value) || 0;

                                // Calculate total score
                                const total = choreography + technicalProficiency + phrasingDynamicMusicality + costumesUniform;
                            ...
                            document.getElementById('phrasing-dynamic-musicality').addEventListener('input', updateTotal);
