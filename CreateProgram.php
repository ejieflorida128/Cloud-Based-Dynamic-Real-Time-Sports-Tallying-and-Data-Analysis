      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Program</li>
          </ol>
                                ...
                                <div class = "top">
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="exampleModalLabel">Register a Program</h1>
                                                    ...
                                                    <?php
                                                            ...
                                                            while($getAllEvents = mysqli_fetch_assoc($queryForAllEvents)){
                                                                    ...
                                                                    if($status == 'completed'){
                                                                        ...
                                                                        $sta =  "<h6 style = 'color: orange;'>$status</h6>";
                                                                    }
                                                                            ...
                                                                            <a href = 'addGames.php?id=$id&&teamCount=$teamCount' class='col-md-4 col-sm-6' style = ' box-shadow: 0 0 15px rgba(0, 0, 0, 0.25); border-radius: 20px; margin: 17px; width: 250px; height: 250px;' id = 'EventBox'>
                                                                                    ...
                                                                                    <div class='information' style = 'margin-top: 20px;'>
                                                                                                ...
                                                                                                <div class = 'title' style = 'display: flex; justify-content: center;'> <h5>$title</h5></div>
                                                                                                  <div class = 'status' style = 'display: flex; justify-content: center;'>$sta</div>
