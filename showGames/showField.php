                         ...
                         <div class="container" style = " padding: 40px; margin: 10px;">
                            ...
                            <div class="table-responsive p-0" style="display: flex; justify-content: space-around; flex-wrap: wrap; gap: 20px; padding: 20px;">
                                ...
                                <div class="slot" style="flex-basis: 30%; max-width: 250px; margin: 10px;">
                                    <a href="runs.php?event_id=<?php echo $event_id ?>&&game_id=<?php echo $game_id ?>&&game_type=<?php echo $game_type ?>&&meter=<?php echo $meter100 ?>"
                                      class="event-box" style="display: block; box-shadow: 0 0 15px rgba(0, 0, 0, 0.25); border-radius: 20px; overflow: hidden; background-color: white; transition: transform 0.3s;">
                                        ...
                                        <div class="information" style="padding: 10px; text-align: center;">
                                            <h3 style="margin: 0; font-size: 18px;">100 Meters</h3>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <!-- 200 meters -->
                                <div class="slot" style="flex-basis: 30%; max-width: 250px; margin: 10px;">
                                    <a href="runs.php?event_id=<?php echo $event_id ?>&&game_id=<?php echo $game_id ?>&&game_type=<?php echo $game_type ?>&&meter=<?php echo $meter200 ?>"
                                      class="event-box" style="display: block; box-shadow: 0 0 15px rgba(0, 0, 0, 0.25); border-radius: 20px; overflow: hidden; background-color: white; transition: transform 0.3s;">
                                        <div class="pictures" style="display: flex; justify-content: center; padding: 20px;">
                                            <img src="../background_image/200meter.jpg" style="width: 150px; height: 150px; border-radius: 15px;">
                                        </div>
                                        <div class="information" style="padding: 10px; text-align: center;">
                                            <h3 style="margin: 0; font-size: 18px;">200 Meters</h3>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <!-- 400 meters relays -->
                                <div class="slot" style="flex-basis: 30%; max-width: 250px; margin: 10px;">
                                   <a href="runs.php?event_id=<?php echo $event_id ?>&&game_id=<?php echo $game_id ?>&&game_type=<?php echo $game_type ?>&&meter=<?php echo $meter400 ?>" 
                                      class="event-box" style="display: block; box-shadow: 0 0 15px rgba(0, 0, 0, 0.25); border-radius: 20px; overflow: hidden; background-color: white; transition: transform 0.3s;">
                                        <div class="pictures" style="display: flex; justify-content: center; padding: 20px;">
                                            <img src="../background_image/400meter.jpg" style="width: 150px; height: 150px; border-radius: 15px;">
                                        </div>
                                        <div class="information" style="padding: 10px; text-align: center;">
                                            <h3 style="margin: 0; font-size: 18px;">400 Meters Relay</h3>
                                        </div>
                                    </a>
                                </div>
                                ...
                                ?>
                                  ...
                                  <!-- javelin -->
                                  <div class="slot" style="flex-basis: 30%; max-width: 250px; margin: 10px;">
                                    <a href="throws.php?event_id=<?php echo $event_id ?>&&game_id=<?php echo $game_id ?>&&game_type=<?php echo $game_type ?>&&meter=<?php echo $javelin ?>"
                                      class="event-box" style="display: block; box-shadow: 0 0 15px rgba(0, 0, 0, 0.25); border-radius: 20px; overflow: hidden; background-color: white; transition: transform 0.3s;">
                                        <div class="pictures" style="display: flex; justify-content: center; padding: 20px;">
                                ...
                                <!-- discus -->
                                <div class="slot" style="flex-basis: 30%; max-width: 250px; margin: 10px;">
                                    <a href="throws.php?event_id=<?php echo $event_id ?>&&game_id=<?php echo $game_id ?>&&game_type=<?php echo $game_type ?>&&meter=<?php echo $discus ?>"
                                      class="event-box" style="display: block; box-shadow: 0 0 15px rgba(0, 0, 0, 0.25); border-radius: 20px; overflow: hidden; background-color: white; transition: transform 0.3s;">
                                        <div class="pictures" style="display: flex; justify-content: center; padding: 20px;">
                                ...
                                <?php }else if($game_type == 'Jumps_Men' || $game_type == 'Jumps_Women'){?>
                                  ...
                                  <!-- long -->
                                  <div class="slot" style="flex-basis: 30%; max-width: 250px; margin: 10px;">
                                    <a href="jumps.php?event_id=<?php echo $event_id ?>&&game_id=<?php echo $game_id ?>&&game_type=<?php echo $game_type ?>&&meter=<?php echo $long ?>"
                                      class="event-box" style="display: block; box-shadow: 0 0 15px rgba(0, 0, 0, 0.25); border-radius: 20px; overflow: hidden; background-color: white; transition: transform 0.3s;">
                                        <div class="pictures" style="display: flex; justify-content: center; padding: 20px;">
                                ...
                                <!-- high -->
                                <div class="slot" style="flex-basis: 30%; max-width: 250px; margin: 10px;">
                                    <a href="jumps.php?event_id=<?php echo $event_id ?>&&game_id=<?php echo $game_id ?>&&game_type=<?php echo $game_type ?>&&meter=<?php echo $high ?>"
                                      class="event-box" style="display: block; box-shadow: 0 0 15px rgba(0, 0, 0, 0.25); border-radius: 20px; overflow: hidden; background-color: white; transition: transform 0.3s;">
                                        <div class="pictures" style="display: flex; justify-content: center; padding: 20px;">
                                ...
                                <!-- triple -->
                                <div class="slot" style="flex-basis: 30%; max-width: 250px; margin: 10px;">
                                   <a href="jumps.php?event_id=<?php echo $event_id ?>&&game_id=<?php echo $game_id ?>&&game_type=<?php echo $game_type ?>&&meter=<?php echo $triple ?>" 
                                      class="event-box" style="display: block; box-shadow: 0 0 15px rgba(0, 0, 0, 0.25); border-radius: 20px; overflow: hidden; background-color: white; transition: transform 0.3s;">
                                        <div class="pictures" style="display: flex; justify-content: center; padding: 20px;">
