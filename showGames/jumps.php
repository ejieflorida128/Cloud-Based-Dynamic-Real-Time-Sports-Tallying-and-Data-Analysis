                                        ...
                                        if($meter == 'long'){
                                                   ...
                                                   <div class="table-responsive p-0">
                                                           ...
                                                           <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Options</th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    $getPlayersForRuns = "SELECT * FROM players WHERE game_id = '$game_id' AND event_id = '$event_id' AND choose_type = 'long'";
                                                                        ...
                                                                        $getResult = mysqli_fetch_assoc($queryGetTeamInfo);
                                                                            ...
                                                                            echo '
                                                                                    <tr>
                                                                                            ...
                                                                                            <td class="align-middle text-center">
                                                                                                <span class="text-secondary text-xs font-weight-bold">Long Jump</span>
                                                                                            </td>
                                                                                            <td class="align-middle text-center">';
                                          ...
                                          <div class="table-responsive p-0">
                                                       ...
                                                       <tbody>
                                                           ...
                                                           $getPlayersForRuns = "SELECT * FROM players WHERE game_id = '$game_id' AND event_id = '$event_id' AND choose_type = 'high'";
                                                           $queryForRuns = mysqli_query($conn,$getPlayersForRuns);
                                                               ...
                                                               $getResult = mysqli_fetch_assoc($queryGetTeamInfo);
                                                                   ...
                                                                   echo '
                                                                           <tr>
                                                                                   ...
                                                                                   <td class="align-middle text-center">
                                                                                       <span class="text-secondary text-xs font-weight-bold">High Jumps</span>
                                                                                   </td>
                                                                                   <td class="align-middle text-center">';
                                            ...
                                            <div class="table-responsive p-0">
                                                         ...
                                                         <tbody>
                                                             ...
                                                             $getPlayersForRuns = "SELECT * FROM players WHERE game_id = '$game_id' AND event_id = '$event_id' AND choose_type = 'triple'";
                                                             $queryForRuns = mysqli_query($conn,$getPlayersForRuns);
                                                                 ...
                                                                 $getResult = mysqli_fetch_assoc($queryGetTeamInfo);
                                                                     ...
                                                                     echo '
                                                                             <tr>
                                                                                     ...
                                                                                     <td class="align-middle text-center">
                                                                                         <span class="text-secondary text-xs font-weight-bold">Triple Jump</span>
                                                                                     </td>
                                                                                     <td class="align-middle text-center">';
