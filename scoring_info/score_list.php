...
session_start();
    ...
    //     $sql = "INSERT INTO events (event_name,number_of_teams,status) VALUES ('$program_name','$number_of_teams','on-going')";
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Score and Program information</h6>
                                ...
                                <div class = "content">
                                    <div class="container-fluid">
                                            <div class="row" >
                                                    ...
                                                    <?php
                                                            $sqlForAllEvents = "SELECT * FROM events ORDER BY id DESC";
                                                            $queryForAllEvents = mysqli_query($conn,$sqlForAllEvents);

                                                            while($getAllEvents = mysqli_fetch_assoc($queryForAllEvents)){
                                                                    ...
                                                                    echo"
                                                                            ...
                                                                            <a href = 'viewDetails.php?event_id=$id&&number_of_teams=$teamCount' class='col-md-4 col-sm-6' style = ' box-shadow: 0 0 15px rgba(0, 0, 0, 0.25); border-radius: 20px; margin: 17px; width: 250px; height: 250px;' id = 'EventBox'>
                                                                                    ...
                                                                                    <div class='information' style = 'margin-top: 20px;'>
                                                                                                ...
                                                                                                <div class = 'title' style = 'display: flex; justify-content: center;'> <h5>$title</h5></div>
                                                                                                  <div class = 'status' style = 'display: flex; justify-content: center;'>Check Details</div>
