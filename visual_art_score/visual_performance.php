...
include('../connection/conn.php');
     ...
     $_SESSION['GameId'] = $_GET['game_id'];
  
     $_SESSION['EventId'] = $_GET['event_id'];
  
     $_SESSION['GameType'] = $_GET['game_type'];
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Criteria and List of Teams</h6>
              <?php
                         ...
                         <div class="container" style = " padding: 40px; display: flex;">
                          ...
                          <?php
                              ...
                              $result = mysqli_query($conn,$sqlGetAllDataFromTeam);
                                ...
                                while($testForTeam = mysqli_fetch_assoc($result)){
                                  ...
                                  if($game_type == 'Charcoal_Rendering'){
                                            ...
                                            <a href = 'criteriaForCharcoalRendering.php?team_id=$teamId' class='col-md-4 col-sm-6' style = ' box-shadow: 0 0 15px rgba(0, 0, 0, 0.25); border-radius: 20px; margin: 17px; width: 250px; height: 250px;' id = 'EventBox'>
                                    ...
                                    <a href = 'criteriaForPencilDrawing.php?team_id=$teamId' class='col-md-4 col-sm-6' style = ' box-shadow: 0 0 15px rgba(0, 0, 0, 0.25); border-radius: 20px; margin: 17px; width: 250px; height: 250px;' id = 'EventBox'>
                                                                      <div class = 'pictures' style = 'display: flex; justify-content: center; margin-top: 10px;'>
                                                                      <img src = '$logos' style = 'width: 150px; height: 140px;'>
                                                                      </div>
                            ...
                            ";
                                    ...
                                    <a href = 'criteriaForPainting.php?team_id=$teamId' class='col-md-4 col-sm-6' style = ' box-shadow: 0 0 15px rgba(0, 0, 0, 0.25); border-radius: 20px; margin: 17px; width: 250px; height: 250px;' id = 'EventBox'>
                                                                      <div class = 'pictures' style = 'display: flex; justify-content: center; margin-top: 10px;'>
                                                                      <img src = '$logos' style = 'width: 150px; height: 140px;'>
                                                                      </div>
                            ...
                            ";
                                    ...
                                    <a href = 'criteriaForPosterMaking.php?team_id=$teamId' class='col-md-4 col-sm-6' style = ' box-shadow: 0 0 15px rgba(0, 0, 0, 0.25); border-radius: 20px; margin: 17px; width: 250px; height: 250px;' id = 'EventBox'>
                                                                      <div class = 'pictures' style = 'display: flex; justify-content: center; margin-top: 10px;'>
                                                                      <img src = '$logos' style = 'width: 150px; height: 140px;'>
                                                                      </div>
                            ...
                            ";
                                    ...
                                    <a href = 'criteriaForPhonePhotography.php?team_id=$teamId' class='col-md-4 col-sm-6' style = ' box-shadow: 0 0 15px rgba(0, 0, 0, 0.25); border-radius: 20px; margin: 17px; width: 250px; height: 250px;' id = 'EventBox'>
                                                                      <div class = 'pictures' style = 'display: flex; justify-content: center; margin-top: 10px;'>
                                                                      <img src = '$logos' style = 'width: 150px; height: 140px;'>
                                                                      </div>
