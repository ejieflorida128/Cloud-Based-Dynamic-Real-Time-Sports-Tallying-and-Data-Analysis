...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <a class="nav-link" href="../loadToCreateProgram.php">
    ...
    <span class="nav-link-text ms-1">Program</span>
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="../scoring_info/loadToScoreList.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Dance Category Teams</li>
          </ol>
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              ...
              <a href="special_performance.php?event_id=<?php echo $_SESSION['EventId']; ?>&&game_id=<?php echo $_SESSION['GameId']; ?>&&game_type=<?php echo $_SESSION['GameType']; ?>" class = "btn btn-danger">Back</a>

              <div class="criteria-container">
                    <div class="criteria-title">Criteria for Judging</div>

                    <div class="criteria-item">
                        <span>Timing and Basic Rhythm</span>
                        <span>25%</span>
                    </div>
                    <div class="criteria-subitem">
                        <ul>
                            <!-- Specific details or sub-criteria can be added here -->
                        </ul>
                    </div>

                    <div class="criteria-item">
                        <span>Body Line and Movement</span>
                        <span>20%</span>
                    </div>
                    <div class="criteria-subitem">
                        <ul>
                    ...
                    <div class="criteria-item">
                        <span>Rhythmic Interpretation</span>
                        <span>15%</span>
                    </div>
                    <div class="criteria-subitem">
                        <ul>
                    ...
                    <div class="criteria-item">
                        <span>Dance Characterization</span>
                        <span>10%</span>
                    </div>
                    <div class="criteria-subitem">
                        <ul>
              ...
              <div class="row" id = 'secondPart'>
                    ...
                    <form action="options.php" method="post">
                        <div class="criteria-container">
                            ...
                            <div class="criteria-item">
                                <label for="timing-rhythm">Timing and Basic Rhythm (25%)</label>
                                <input type="number" id="timing-rhythm" name="A" placeholder="Score (0 - 25)" min="0" max="25" value="<?php echo htmlspecialchars($getResult['A']); ?>">
                            </div>
                            <div class="criteria-subitem">
                                <ul>
                                    <!-- Add any specific details or sub-criteria if needed -->
                                </ul>
                            </div>

                            <div class="criteria-item">
                                <label for="body-line-movement">Body Line and Movement (20%)</label>
                                <input type="number" id="body-line-movement" name="B" placeholder="Score (0 - 20)" min="0" max="20" value="<?php echo htmlspecialchars($getResult['B']); ?>">
                            </div>
                            <div class="criteria-subitem">
                                <ul>
                                    <!-- Add any specific details or sub-criteria if needed -->
                            ...
                            <div class="criteria-item">
                                <label for="floor-craft">Floor Craft (15%)</label>
                                <input type="number" id="floor-craft" name="C" placeholder="Score (0 - 15)" min="0" max="15" value="<?php echo htmlspecialchars($getResult['C']); ?>">
                            </div>
                            <div class="criteria-subitem">
                                <ul>
                                    <!-- Add any specific details or sub-criteria if needed -->
                            ...
                            <div class="criteria-item">
                                <label for="rhythmic-interpretation">Rhythmic Interpretation (15%)</label>
                                <input type="number" id="rhythmic-interpretation" name="D" placeholder="Score (0 - 15)" min="0" max="15" value="<?php echo htmlspecialchars($getResult['D']); ?>">
                            </div>
                            <div class="criteria-subitem">
                                <ul>
                                    <!-- Add any specific details or sub-criteria if needed -->
                            ...
                            <div class="criteria-item">
                                <label for="footwork">Footwork (15%)</label>
                                <input type="number" id="footwork" name="E" placeholder="Score (0 - 15)" min="0" max="15" value="<?php echo htmlspecialchars($getResult['E']); ?>">
                            </div>
                            <div class="criteria-subitem">
                                <ul>
                                    <!-- Add any specific details or sub-criteria if needed -->
                            ...
                            <div class="criteria-item">
                                <label for="dance-characterization">Dance Characterization (10%)</label>
                                <input type="number" id="dance-characterization" name="F" placeholder="Score (0 - 10)" min="0" max="10" value="<?php echo htmlspecialchars($getResult['F']); ?>">
                            </div>
                            <div class="criteria-subitem">
                                <ul>
                                    <!-- Add any specific details or sub-criteria if needed -->
                        ...
                        <?php
                        // Additional PHP logic if needed
                                                }
                        ?>
                    </form>
                    ...
                    <script>
                        function updateTotal() {
                            ...
                            const timingRhythm = parseFloat(document.getElementById('timing-rhythm').value) || 0;
                            const bodyLineMovement = parseFloat(document.getElementById('body-line-movement').value) || 0;
                            const floorCraft = parseFloat(document.getElementById('floor-craft').value) || 0;
                            const rhythmicInterpretation = parseFloat(document.getElementById('rhythmic-interpretation').value) || 0;
                            const footwork = parseFloat(document.getElementById('footwork').value) || 0;
                            const danceCharacterization = parseFloat(document.getElementById('dance-characterization').value) || 0;

                            // Calculate total score
                            const total = timingRhythm + bodyLineMovement + floorCraft + rhythmicInterpretation + footwork + danceCharacterization;
                        ...
                        document.getElementById('timing-rhythm').addEventListener('input', updateTotal);
                        document.getElementById('body-line-movement').addEventListener('input', updateTotal);
                        document.getElementById('floor-craft').addEventListener('input', updateTotal);
                        document.getElementById('rhythmic-interpretation').addEventListener('input', updateTotal);
                        document.getElementById('footwork').addEventListener('input', updateTotal);
