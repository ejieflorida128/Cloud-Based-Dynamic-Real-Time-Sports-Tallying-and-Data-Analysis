          ...
          <div class="card mb-4">
            <div class="card-header pb-0">
              ...
              <div class="criteria-container">
                        ...
                        <div class="criteria-item">
                            <span>Phrasing, Dynamic, and Musicality</span>
                            <span>20%</span>
                        </div>
                        <div class="criteria-subitem">
                            <ul>
                        ...
                        <div class="criteria-item">
                            <span>Costumes and Uniform</span>
                            <span>10%</span>
                        </div>
                        <div class="criteria-subitem">
                            <ul>
                    ...
                    ?>
                            ...
                            <form action="options.php" method="post">
                                <div class="criteria-container">
                                    ...
                                    <div class="criteria-item">
                                        <label for="choreography">Choreography (40%)</label>
                                        <input type="number" id="choreography" name="A" placeholder="Score (0 - 40)" min="0" max="40" value="<?php echo htmlspecialchars($getResult['A']); ?>">
                                    </div>
                                    <div class="criteria-subitem">
                                        <ul>
                                            <!-- Add any specific details or sub-criteria if needed -->
                                    ...
                                    <div class="criteria-item">
                                        <label for="technical-proficiency">Technical Proficiency (30%)</label>
                                        <input type="number" id="technical-proficiency" name="B" placeholder="Score (0 - 30)" min="0" max="30" value="<?php echo htmlspecialchars($getResult['B']); ?>">
                                    </div>
                                    <div class="criteria-subitem">
                                        <ul>
                                            <!-- Add any specific details or sub-criteria if needed -->
                                    ...
                                    <div class="criteria-item">
                                        <label for="phrasing-dynamic">Phrasing, Dynamic, and Musicality (20%)</label>
                                        <input type="number" id="phrasing-dynamic" name="C" placeholder="Score (0 - 20)" min="0" max="20" value="<?php echo htmlspecialchars($getResult['C']); ?>">
                                    </div>
                                    <div class="criteria-subitem">
                                        <ul>
                                            <!-- Add any specific details or sub-criteria if needed -->
                                    ...
                                    <div class="criteria-item">
                                        <label for="costumes">Costumes and Uniform (10%)</label>
                                        <input type="number" id="costumes" name="D" placeholder="Score (0 - 10)" min="0" max="10" value="<?php echo htmlspecialchars($getResult['D']); ?>">
                                    </div>
                                    <div class="criteria-subitem">
                                        <ul>
                                            <!-- Add any specific details or sub-criteria if needed -->
                                    ...
                                    <input type="text" name="gameType" hidden value="Mass_Dance">
                            ...
                            <script>
                                function updateTotal() {
                                    ...
                                    const choreography = parseFloat(document.getElementById('choreography').value) || 0;
                                    const technicalProficiency = parseFloat(document.getElementById('technical-proficiency').value) || 0;
                                    const phrasingDynamic = parseFloat(document.getElementById('phrasing-dynamic').value) || 0;
                                    const costumes = parseFloat(document.getElementById('costumes').value) || 0;

                                    // Calculate total score
                                    const total = choreography + technicalProficiency + phrasingDynamic + costumes;
                                ...
                                document.getElementById('choreography').addEventListener('input', updateTotal);
                                document.getElementById('technical-proficiency').addEventListener('input', updateTotal);
                                document.getElementById('phrasing-dynamic').addEventListener('input', updateTotal);
                                document.getElementById('costumes').addEventListener('input', updateTotal);
