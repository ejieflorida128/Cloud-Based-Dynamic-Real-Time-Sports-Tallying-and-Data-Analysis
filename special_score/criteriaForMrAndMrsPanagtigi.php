            ...
            <div class="card-header pb-0">
              ...
              <div class="criteria-container">
                    ...
                    <div class="criteria-subitem">
                        <ul>
                            <li>Overall impact of beauty (beauty of the face and figure in congruence with the costume fitting and projection)</li>
                    ...
                    <div class="criteria-item">
                        <span>Question and Answer Portion</span>
                        <span>30%</span>
                    </div>
                    <div class="criteria-subitem">
                        <ul>
                    ...
                    ?>
                        ...
                        <form action="options.php" method="post">
                            <div class="criteria-container">
                                ...
                                <div class="criteria-item">
                                    ...
                                    <input type="number" id="production-number" name="A" placeholder="Score (0 - 20)" min="0" max="20" value="<?php echo htmlspecialchars($getResult['A']); ?>">
                                </div>
                                <div class="criteria-subitem">
                                    <ul>
                                ...
                                <div class="criteria-item">
                                    ...
                                    <input type="number" id="sports-wear" name="B" placeholder="Score (0 - 25)" min="0" max="25" value="<?php echo htmlspecialchars($getResult['B']); ?>">
                                </div>
                                <div class="criteria-subitem">
                                    <ul>
                                        <li>Overall impact of beauty (face and figure congruence with costume fitting and projection)</li>
                                ...
                                <div class="criteria-item">
                                    ...
                                    <input type="number" id="modern-terno" name="C" placeholder="Score (0 - 25)" min="0" max="25" value="<?php echo htmlspecialchars($getResult['C']); ?>">
                                </div>
                                <div class="criteria-subitem">
                                    <ul>
                                        <li>Overall impact of beauty (face and figure congruence with costume fitting and projection)</li>
                                ...
                                <div class="criteria-item">
                                    ...
                                    <input type="number" id="qa-portion" name="D" placeholder="Score (0 - 30)" min="0" max="30" value="<?php echo htmlspecialchars($getResult['D']); ?>">
                                </div>
                                <div class="criteria-subitem">
                                    <ul>
                                        <li>Content of the Answer</li>
                        ...
                        <script>
                            function updateTotal() {
                                ...
                                const productionNumber = parseFloat(document.getElementById('production-number').value) || 0;
                                const sportsWear = parseFloat(document.getElementById('sports-wear').value) || 0;
                                const modernTerno = parseFloat(document.getElementById('modern-terno').value) || 0;
                                const qaPortion = parseFloat(document.getElementById('qa-portion').value) || 0;

                                // Calculate total score
                                const total = productionNumber + sportsWear + modernTerno + qaPortion;
                            ...
                            document.getElementById('production-number').addEventListener('input', updateTotal);
                            document.getElementById('sports-wear').addEventListener('input', updateTotal);
                            document.getElementById('modern-terno').addEventListener('input', updateTotal);
