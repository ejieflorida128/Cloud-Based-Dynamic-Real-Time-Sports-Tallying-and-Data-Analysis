                                        ...
                                        <div class="forInformation1">
                                                    ...
                                                    <div class="form-group" style = "margin: 40px; margin-left: 100px;">
                                                          ...
                                                          <?php
                                                                ...
                                                                if($_SESSION['GameType'] == 'Runs_Men' || $_SESSION['GameType'] == 'Runs_Women'){
                                                                    if($_SESSION['meter'] == '100meter' || $_SESSION['meter'] == '200meter'){
                                                                      $val = 'Default';
                                                                  ...
                                                                  $val = 2;
                                                                  echo '<input type="text" id="player_count" name="player_count" class="form-control" style="width: 10vw;" readonly value="' . $val . '">';
                                                                }else if($_SESSION['GameType'] == 'Badminton_Men'){
                                                                  $val = 2;
                                                                  echo '<input type="text" id="player_count" name="player_count" class="form-control" style="width: 10vw;" readonly value="' . $val . '">';
                                                                }else if($_SESSION['GameType'] == 'Badminton_Women'){
                                                                  $val = 2;
                                                                  echo '<input type="text" id="player_count" name="player_count" class="form-control" style="width: 10vw;" readonly value="' . $val . '">';
                                                                }else if($_SESSION['GameType'] == 'Table_tennis_Men'){
                                                                  $val = 2;
                                                                  echo '<input type="text" id="player_count" name="player_count" class="form-control" style="width: 10vw;" readonly value="' . $val . '">';
                                                                }else if($_SESSION['GameType'] == 'Table_tennis_Women'){
                                                                  $val = 2;
                                                                  echo '<input type="text" id="player_count" name="player_count" class="form-control" style="width: 10vw;" readonly value="' . $val . '">';
                                                              ...
                                                              if($game_type == 'Basketball_Men' || $game_type == 'Basketball_Women'){
                                                                                    ...
                                                                                    <div class="row">';
                                                                                                        ...
                                                                                                        for($x = 1; $x <= 2; $x++){
                                                                                                         ...
                                                                                                         $team_id = $_SESSION['idOfTeam'];
                                                                                                            ...
                                                                                                            $selectFromPlayers = "SELECT * FROM players WHERE game_id = $game_id AND event_id = $event_id AND team_id = $team_id AND player_number = '$condition' AND choose_type = '100meter'";
                                                                                                            $queryForPlayers = mysqli_query($conn,$selectFromPlayers);
                                                                                    ...
                                                                                    <div class="row">';
                                                                                                        ...
                                                                                                        for($x = 1; $x <= 2; $x++){
                                                                                                         ...
                                                                                                         $team_id = $_SESSION['idOfTeam'];
                                                                                                            ...
                                                                                                            $selectFromPlayers = "SELECT * FROM players WHERE game_id = $game_id AND event_id = $event_id AND team_id = $team_id AND player_number = '$condition' AND choose_type = '200meter'";
                                                                                                            $queryForPlayers = mysqli_query($conn,$selectFromPlayers);
                                                                                    ...
                                                                                    <div class="row">';
                                                                                                        ...
                                                                                                        for($x = 1; $x <=  4; $x++){
                                                                                                         ...
                                                                                                         $team_id = $_SESSION['idOfTeam'];
                                                                                                            ...
                                                                                                            $selectFromPlayers = "SELECT * FROM players WHERE game_id = $game_id AND event_id = $event_id AND team_id = $team_id AND player_number = '$condition' AND choose_type = '400meter'";
                                                                                                            $queryForPlayers = mysqli_query($conn,$selectFromPlayers);
                                                                                 ...
                                                                                 <div class="row">';
                                                                                                     ...
                                                                                                     for($x = 1; $x <= 2; $x++){
                                                                                                      ...
                                                                                                      $team_id = $_SESSION['idOfTeam'];
                                                                                                         ...
                                                                                                         $selectFromPlayers = "SELECT * FROM players WHERE game_id = $game_id AND event_id = $event_id AND team_id = $team_id AND player_number = '$condition' AND choose_type = 'javelin'";
                                                                                                         $queryForPlayers = mysqli_query($conn,$selectFromPlayers);
                                                                                 ...
                                                                                 <div class="row">';
                                                                                                     ...
                                                                                                     for($x = 1; $x <= 2; $x++){
                                                                                                      ...
                                                                                                      $team_id = $_SESSION['idOfTeam'];
                                                                                                         ...
                                                                                                         $selectFromPlayers = "SELECT * FROM players WHERE game_id = $game_id AND event_id = $event_id AND team_id = $team_id AND player_number = '$condition' AND choose_type = 'discus'";
                                                                                                         $queryForPlayers = mysqli_query($conn,$selectFromPlayers);
                                                                                 ...
                                                                                 <div class="row">';
                                                                                                     ...
                                                                                                     for($x = 1; $x <= 2; $x++){
                                                                                                      ...
                                                                                                      $team_id = $_SESSION['idOfTeam'];
                                                                                                         ...
                                                                                                         $selectFromPlayers = "SELECT * FROM players WHERE game_id = $game_id AND event_id = $event_id AND team_id = $team_id AND player_number = '$condition' AND choose_type = 'shotput'";
                                                                                                         $queryForPlayers = mysqli_query($conn,$selectFromPlayers);
                                                               ...
                                                               ';
                                                                ...
                                                                // end sa jumps
                                                                  ...
                                                                  // start sa Badminton single and double

                                                                        if($game_type == 'Badminton_Men'){
                                                                              // for men
                                                                                             ...
                                                                                             <div class="row">';
                                                                                                                 ...
                                                                                                                 for($x = 2; $x <=2; $x++){
                                                                                                                  ...
                                                                                                                  $team_id = $_SESSION['idOfTeam'];
                                                                                                                     ...
                                                                                                                     if (empty($getData['name'])) {
                                                                                                                       $name1 = 'Please add player name!';
                                                                                                                       $name1_1 = 'Please add player name!';
                                                                                                                   } else {
                                                                                                                       $name1 = htmlspecialchars($getData['name']);
                                                                                                                       $name1_1 = htmlspecialchars($getData['name1']);
                                                                                                                   }
              
                                                                                                                    
                                                                                                                        $age1 = isset($getData['age']) ? htmlspecialchars($getData['age']) : 0;
                                                                                                                        $age1_1 = isset($getData['age1']) ? htmlspecialchars($getData['age1']) : 0;
                                                                                                                 ...
                                                                                                                 echo "
                                                                                                                 <div class='box' class='col-md-4 col-sm-6' style='box-shadow: 0 0 15px rgba(0, 0, 0, 0.25); border-radius: 20px; margin: 17px; width: 45%; height: 400px;'>
                                                                                                                     <label style='margin-top: 30px;'>Player 1 Name: </label>
                                                                                                                     <input type='text' class='form-control'name = '$getName1' value='$name1'> 
                                                                                                                     <label style='margin-top: 10px;'>Player 1 Age: </label>
                                                                                                                     <input type='text' class='form-control' name = '$getAge1' value='$age1'>


                                                                                                                      <label style='margin-top: 30px;'>Player 2 Name: </label>
                                                                                                                     <input type='text' class='form-control'name = '$getName2' value='$name1_1'> 
                                                                                                                     <label style='margin-top: 10px;'>Player 2 Age: </label>
                                                                                                                     <input type='text' class='form-control' name = '$getAge2' value='$age1_1'>
